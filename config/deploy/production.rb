...
server 'xxxx', user: 'deploy', roles: %w[web app db], primary: true, my_property: :my_value
...
# set :lets_encrypt_domains, 'xxxx-backend.riccardo.io www.xxxx-backend.riccardo.io'
