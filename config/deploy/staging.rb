...
server 'xxxx', user: 'deploy', roles: %w[web app db]#, my_property: :my_value

# Nginx settings
set :nginx_domains, 'xxxx'
...
# set :lets_encrypt_domains, 'xxxx-backend-staging.riccardo.io www.xxxx-backend-staging.riccardo.io'
# set :lets_encrypt_email, 'admin@riccardo.io'
