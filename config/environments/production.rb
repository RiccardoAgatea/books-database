Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "generic_backend_production"
  ...
  config.action_mailer.default_url_options = { host: Rails.application.credentials.dig(Rails.env.to_sym, :url, :backend, :host), protocol: Rails.application.credentials.dig(Rails.env.to_sym, :url, :backend, :protocol) || 'http' }
